...
We evaluated three inversion methods on three synthetic datasets generated from Neural Ordinary Differential Equations (Neural ODEs) and Neural Operators (FNO): the Simple Harmonic Oscillator (SHO), the Damped Harmonic Oscillator (DHO), and the 1D Advection equation.
